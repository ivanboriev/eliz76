        ...
        <v-card-text>
            <v-container grid-list-md>
                <v-layout wrap>
                    ...
                    <v-flex xs12 md4>
                        <v-text-field v-model="equip.factory_number"
                                      label="Заводской номер"></v-text-field>
                    </v-flex>
                    <v-flex xs12 md4>
                        <v-dialog
                            ref="modal"
                        ...
                        >
                            ...
                            <v-date-picker :first-day-of-week="0" locale="ru"
                                           v-model="equip.check_date" scrollable>
                                <v-spacer></v-spacer>
                                <v-btn text color="primary" @click="modal = false">Отмена
                                </v-btn>
                                <v-btn text color="primary"
                                       @click="$refs.modal.save(equip.check_date)">OK
                                </v-btn>
                            </v-date-picker>
                        </v-dialog>
                    </v-flex>
